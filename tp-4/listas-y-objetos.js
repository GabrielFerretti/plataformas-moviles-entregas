...
function laPersonaMayor(listaDePersonas) {
    ...
    let personaMayor = listaDePersonas[0]; // Suponemos que la primera persona es la mayor

    for (let i = 1; i < listaDePersonas.length; i++) {
        if (listaDePersonas[i].edad > personaMayor.edad) {
            // Si encontramos una persona con una edad mayor, actualizamos la personaMayor
